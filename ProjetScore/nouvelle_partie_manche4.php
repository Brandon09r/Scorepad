...
<div class="container mt-4 text-center">
	...
	if(isset($_SESSION['nb_joueurs'])) {
		...
		echo "<tr>";
		echo "<th class='col-4 align-middle'><img src='img/En-tete/player.png' alt='joueur'></th>";
		echo "<th class='col-1 align-middle'>Manche 1</th>";
        echo "<th class='col-1 align-middle'>Manche 2</th>";
        echo "<th class='col-1 align-middle'>Manche 3</th>";
		echo "<th class='col-1 align-middle'>Manche 4</th>";
        echo "<th class='col-4 align-middle'><img src='img/En-tete/score.png' alt='score'></th>";
		echo "</tr>";
		echo "</thead>";
		echo "<tbody>";
		for ($i=1; $i<=$nb_joueurs; $i++) {
            ...
            echo "<td><div class='centered-number'><input type='number' name='manche1-$i' class='form-control text-center' id='manche1-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
            echo "<td><div class='centered-number'><input type='number' name='manche2-$i' class='form-control text-center' id='manche2-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
            echo "<td><div class='centered-number'><input type='number' name='manche3-$i' class='form-control text-center' id='manche3-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
			echo "<td><div class='centered-number'><input type='number' name='manche4-$i' class='form-control text-center' id='manche4-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
...
<script>
    function calculateTotalScore() {
        <?php
        for ($i=1; $i<=$nb_joueurs; $i++) {
            echo "var manche1 = parseInt(document.getElementById('manche1-$i').value) || 0;";
            echo "var manche2 = parseInt(document.getElementById('manche2-$i').value) || 0;";
            echo "var manche3 = parseInt(document.getElementById('manche3-$i').value) || 0;";
			echo "var manche4 = parseInt(document.getElementById('manche4-$i').value) || 0;";
            echo "var totalScore = manche1 + manche2 + manche3 + manche4;";
