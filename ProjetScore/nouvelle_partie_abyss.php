...
<div class="container mt-4 text-center">
	...
	if(isset($_SESSION['nb_joueurs'])) {
		...
		echo "<th class='col-1'><img src='img/Abyss/location.png' alt='lieux'></th>";
        echo "<th class='col-1'><img src='img/Abyss/lord.png' alt='seigneurs'></th>";
        echo "<th class='col-1'><img src='img/Abyss/ally.png' alt='alliés'></th>";
		echo "<th class='col-1'><img src='img/Abyss/monster.png' alt='monstres'></th>";
		...
		for ($i=1; $i<=$nb_joueurs; $i++) {
            ...
            echo "<td><div class='centered-number'><input type='number' name='location-$i' class='form-control text-center' id='location-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
            echo "<td><div class='centered-number'><input type='number' name='lord-$i' class='form-control text-center' id='lord-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
            echo "<td><div class='centered-number'><input type='number' name='ally-$i' class='form-control text-center' id='ally-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
			echo "<td><div class='centered-number'><input type='number' name='monster-$i' class='form-control text-center' id='monster-$i' oninput='calculateTotalScore()' value='0' onkeydown='handleEnterKeyPress(event, $i)'></div></td>";
...
<script>
    function calculateTotalScore() {
        <?php
        for ($i=1; $i<=$nb_joueurs; $i++) {
            echo "var location = parseInt(document.getElementById('location-$i').value) || 0;";
            echo "var lord = parseInt(document.getElementById('lord-$i').value) || 0;";
            echo "var ally = parseInt(document.getElementById('ally-$i').value) || 0;";
			echo "var monster = parseInt(document.getElementById('monster-$i').value) || 0;";
            echo "var totalScore = location + lord + ally + monster;";
